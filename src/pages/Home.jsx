  ...
  return (
    <section>
      ...
      <main>
        ...
        <section className='page-section section-bg clearfix'>
            ...
            <div className='intro'>
              ...
              <motion.div
                ...
                <div className='intro-button mx-auto'>
                  <Link
                    className='btn btn-danger btn-xl bg-danger text-white'
                    to='courses'>
                    Enroll now!
                  </Link>
                </div>
          ...
          <div className='container'>
            <div className='intro'>
              ...
              <motion.div
                ...
                <div className='intro-button mx-auto'>
                  <Link
                    className='btn btn-danger bg-danger btn-xl text-white'
                    to='/products'>
                    Visit Gallery!
                  </Link>
                </div>
        ...
        <section className='page-section section-bg clearfix'>
          <div className='testimonial_section text-center'>
            <p className='h1'>
              <span className='badge bg-danger text-white my-4'>
                Testimonials
              </span>
            </p>
            <Testimonial />
