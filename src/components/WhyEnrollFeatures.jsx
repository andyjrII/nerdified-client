    ...
    <div className='row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-4'>
      ...
      <div className='col-md-3'>
        ...
        >
          <div className='d-flex flex-column h-100 p-3 pb-3 text-white'>
            <p className='pt-5 my-4 lh-1 why-enroll-text'>
              After completing your coursework, we provide an intership program
              that allows you to apply what you've learned in real-world
              scenarios. This hands-on experience is invaluable for building
              your resume & gaining practical skills that employers seek.
            </p>
            <ul className='d-flex list-unstyled mt-auto'>
              <li className='d-flex align-items-center align-content-center mx-auto'>
                <FontAwesomeIcon
      ...
      <div className='col-md-3'>
        ...
        >
          <div className='d-flex flex-column h-100 p-3 pb-3 text-shadow-1'>
            <p className='pt-5 my-4 lh-1 why-enroll-text'>
              We understand that everyone has different schedules & commitments.
              That's why we offer flexible learning options that allow you to
              choose your preferred class times and the number of sessions per
              week. Learn at your own pace & on your own terms.
            </p>
            <ul className='d-flex list-unstyled mt-auto'>
              <li className='d-flex align-items-center align-content-center mx-auto'>
                <FontAwesomeIcon
