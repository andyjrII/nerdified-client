  ...
  return (
    <div className="relative min-h-screen bg-white text-gray-900">
      <div className="relative min-h-screen">
        ...
        {/* Why Enroll Section - alternating band (fixed light, theme does not affect home) */}
        ...
        {/* Live learning CTAs (students + tutors) - single band */}
        <section className="w-full bg-white py-12 md:py-16">
          <div className="space-y-16">
            {/* Marketing Section 1 - Student CTA */}
                  ...
                  <Card className="bg-white shadow-xl">
                    ...
                    <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2 z-30">
                      <Button
                        asChild
                        size="lg"
                        className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-6 text-base font-bold shadow-lg"
                      >
        ...
        {/* Latest Posts Section - alternating band (fixed light) */}
        <section className="w-full bg-gray-100 py-12 md:py-16">
          <div className="container mx-auto px-4">
            <h1 className="text-center mb-8">
